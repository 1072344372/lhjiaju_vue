    ...
    <div class="login_box">
      ...
      <el-form ref="loginFormRef" :model="loginForm" :rules="loginFormRules" label-width="0px" class="login_form">
        ...
        <el-form-item prop="username">
          <el-input v-model.trim="loginForm.username" prefix-icon="Avatar" placeholder="请输入管理员账户"></el-input>
        </el-form-item>
        <!-- 密码 -->
        <el-form-item prop="password">
          <el-input v-model="loginForm.password" prefix-icon="Lock" type="password"
                    @keyup.enter.native="login" :show-password="true" placeholder="请输入管理员密码"></el-input>
        </el-form-item>
        <!-- 按钮区域 -->
